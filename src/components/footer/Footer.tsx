  ...
  const socials = [
	...
	return (
		<footer className='dark:text-white mt-16'>
			<div className='container mx-auto flex flex-col flex-wrap min-[1400px]:justify-center min-[1024px]:justify-start min-[768px]:justify-center sm:flex-row sm:py-[3%] my-10 px-2'>
				<div>
